...
public class CoreNLPTest {
	...
	public static void main(String[] args) {
	    ...
	    // String text = "Alice is in the room. She is sitting on the chair. She is looking pale."; // Add your text here!
	    String text = "There is a table. A man looks at it."; // Add your text here!
		
	    CoreNLP.getInstance().process(text);
